package com.desailly.backdropsbliss.Detalle;
...
public class Detalle_administrador extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Picasso.get().load(ImagenDetalle).placeholder(R.drawable.usuario).into(ImagenDetalleAdmin);
        }catch (Exception e){
            Picasso.get().load(R.drawable.usuario).into(ImagenDetalleAdmin);
        }
